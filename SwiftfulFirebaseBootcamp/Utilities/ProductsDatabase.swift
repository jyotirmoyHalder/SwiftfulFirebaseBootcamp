...
// MARK: - THIS FUNCTION WAS IN PRODUCTVIEWMODEL BUT WE ARE TRANSFERING IT HERE AS WE NEED IT ONLY FOR ONE TIME
...
//                guard let productArray = products.products else { return }
//
